...
import { sendButtons, sendInteractiveMessage } from "./button.js";
...
export async function extendSocket(sock) {
    ...
    sock.sendButtons = async function (jid, data = {}, options = {}) {
        return await sendButtons(this, jid, data, options);
    };
    
    sock.sendInteractiveMessage = async function (jid, content, options = {}) {
        return await sendInteractiveMessage(this, jid, content, options);
    };
