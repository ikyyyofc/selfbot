...
export async function extendSocket(sock) {
    ...
    sock.user.lid = jidNormalizedUser(sock.user.lid);
    ...
    sock.sendButtons = async (jid, contentText, footerText, buttons, headerType, headerMessage, quoted = {}) => {
        ...
        switch (headerType) {
            case 1: // TEXT
                buttonsMessage.text = headerMessage;
                break;
            case 3: // DOCUMENT
                buttonsMessage.documentMessage = headerMessage;
                break;
            case 4: // IMAGE
                buttonsMessage.imageMessage = headerMessage;
                break;
            case 5: // VIDEO
                buttonsMessage.videoMessage = headerMessage;
                break;
            case 6: // LOCATION
                buttonsMessage.locationMessage = headerMessage;
                break;
        }
