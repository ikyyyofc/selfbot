...
export default async function serialize(m, sock) {
    ...
    if (msg?.contextInfo?.quotedMessage) {
        ...
        let getJidQuoted = msg.contextInfo.participant.includes("@lid") ? await sock.getJidParticipants(m.chat, msg.contextInfo.participant)
        m.quoted = {
            key: {
                remoteJid: m.chat,
                fromMe:
            ...
            text:
                ...
                "",
            sender: msg.contextInfo.participant.includes("@lid") ? await sock.getJidParticipants(m.chat, msg.contextInfo.participant) : msg.contextInfo.participant,
