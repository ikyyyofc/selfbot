...
- Status Inisialisasi: *${
                        stats.initialized ? "✅ Terinisialisasi" : "❌ Belum"
                    }*`;
            ...
            case "info":
                ...
                try {
                    ...
                    if (!metadata) {
                        return await reply(
                            "Grup ini tidak ditemukan di cache. Coba `.groupcache refresh` dulu."
                        );
                    }
...
- Deskripsi: ${
                    ...
                    await reply(
                        `❌ Gagal mendapatkan info cache: ${e.message}`
                    );
                }
                break;
            ...
            case "list":
                try {
                    ...
                    await reply(
                        `❌ Gagal mendapatkan daftar grup: ${e.message}`
                    );
                }
                break;
            ...
            case "clear":
                try {
                    groupCache.clear();
                    await reply(
                        "✅ Semua cache grup berhasil dibersihkan. Cache akan diinisialisasi ulang."
                    );
