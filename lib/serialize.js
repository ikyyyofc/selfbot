...
export default function serialize(m, sock) {
    ...
    if (msg?.contextInfo?.quotedMessage) {
        ...
        m.quoted = {
            key: {
                remoteJid: msg.contextInfo.remoteJid || m.from,
                fromMe: msg.contextInfo.participant === jidNormalizedUser(sock.user.id),
            ...
            text:
                ...
                "",
            sender: jidNormalizedUser(msg.contextInfo.participant || m.from),
    ...
    m.reply = async (content, options = {}) => {
        ...
        return await sock.sendMessage(m.from, message, {
            quoted: m,
            ...options
        });
    };
