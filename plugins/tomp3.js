...
export default async ({ m, sock, fileBuffer, reply }) => {
    if (!fileBuffer) {
        await reply("Kirim/reply video yang mau dikonversi ke audio (MP3)!");
        return;
    }
    ...
    await sock.sendMessage(m.chat, { audio: outBuffer, mimetype: "audio/mp4" }, { quoted: m });
